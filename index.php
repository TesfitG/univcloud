							...
							<header class="header">
								<div class="inner">
									...
									<a href="index.html" class="logo">
										<span class="symbol"><img src="images/logo.png" alt="Title" /></span><span class="title">Univ-Cloud</span>
									</a>
								</div>
							</header>
							<!-- Menu -->
					...
					<div class="col-md-3">
							<div class="a">
								<a href="#test-popup-1" class="open-popup-link">
									<img src="images/astu.png" class="img-responsive" alt="Responsive image">
									<div class="img-hover glass">
										<div class="c-table">
											<div class="ct-cell">
												<h3 class="img-title">ASTU</h3>
											</div>
										</div>
									</div>
								</a>
						...
						<div class="col-md-3">
							<div class="a">
								<a href="#test-popup-2" class="open-popup-link">
									<img src="images/aaulogo.png"   class="img-responsive" alt="Responsive image">
									<div class="img-hover glass">
										<div class="c-table">
											<div class="ct-cell">
												<h3 class="img-title">AAU</h3>
											</div>
										</div>
									</div>
								</a>
						...
						<div class="col-md-3">
							<div class="a">
								<a href="#test-popup-4" class="open-popup-link">
									<img src="images/dulogo.png" class="img-responsive" alt="Responsive image">
									<div class="img-hover shoes-glass">
										<div class="c-table">
											<div class="ct-cell">
												<h3 class="img-title">DU</h3>
											</div>
										</div>
									</div>
								</a>
